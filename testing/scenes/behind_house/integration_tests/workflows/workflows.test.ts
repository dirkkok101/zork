/**
 * Workflow Tests - Behind House Scene
...
describe('Workflows - Behind House Scene', () => {
  ...
  describe('Systematic Exploration Workflow', () => {
    it('should complete thorough scene exploration', () => {
      ...
      const exitInResult = testEnv.commandProcessor.processCommand('in');
      expect(exitInResult).toBeDefined();

      // Return to original scene
      if (exitInResult.countsAsMove) {
        testEnv.commandProcessor.processCommand('out');
      }
