/**
 * Scoring Tests - South of House Scene
...
describe('Scoring - South of House Scene', () => {
  ...
  describe('First Visit Scoring', () => {
    it('should award points for first visit to south_of_house', () => {
      // Reset scoring state
      scoringHelper.resetScoringState();
      testEnv.services.gameState.setCurrentScene('south_of_house');
      testEnv.services.gameState.updateSceneRuntimeState('south_of_house', { visited: false });
      ...
      expect(testEnv.services.gameState.hasVisitedScene('south_of_house')).toBe(true);
