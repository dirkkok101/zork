...
describe('Scoring - Forest Scene', () => {
  ...
  describe('First Visit Scoring', () => {
    it('should award points for first visit to forest_2', () => {
      // Reset scoring state
      scoringHelper.resetScoringState();
      testEnv.services.gameState.setCurrentScene('forest_2');
      testEnv.services.gameState.updateSceneRuntimeState('forest_2', { visited: false });
      ...
      expect(testEnv.services.gameState.hasVisitedScene('forest_2')).toBe(true);
