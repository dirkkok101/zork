/**
 * Scoring Tests - Sandy Beach Scene
...
describe('Scoring - Sandy Beach Scene', () => {
  ...
  describe('First Visit Scoring', () => {
    it('should award points for first visit to beach', () => {
      // Reset scoring state
      scoringHelper.resetScoringState();
      testEnv.services.gameState.setCurrentScene('beach');
      testEnv.services.gameState.updateSceneRuntimeState('beach', { visited: false });
      ...
      expect(testEnv.services.gameState.hasVisitedScene('beach')).toBe(true);
