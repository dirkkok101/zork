/**
 * Integration Test Factory for Attic
 * Auto-generated factory for attic scene tests
 */
...
export class AtticIntegrationTestFactory {
  /**
   * Create a complete integration test environment for Attic
   */
