...
describe('Scoring - Forest Scene', () => {
  ...
  describe('First Visit Scoring', () => {
    it('should award points for first visit to forest_3', () => {
      // Reset scoring state
      scoringHelper.resetScoringState();
      testEnv.services.gameState.setCurrentScene('forest_3');
      testEnv.services.gameState.updateSceneRuntimeState('forest_3', { visited: false });
      ...
      expect(testEnv.services.gameState.hasVisitedScene('forest_3')).toBe(true);
