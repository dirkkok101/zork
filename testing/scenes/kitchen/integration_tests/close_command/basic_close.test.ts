...
describe('Close Command - Kitchen Scene', () => {
  ...
  describe('Game State Tracking', () => {
    ...
    it('should persist closed state across commands', () => {
      ...
      // Close the container
      closeHelper.executeCloseTarget('sbag');
      closeHelper.verifyItemClosed('sbag');
    ...
    it('should change container examination after closing', () => {
      ...
      const openExamine = closeHelper.executeClose('examine sbag');
      ...
      const closedExamine = closeHelper.executeClose('examine sbag');
  ...
  describe('State Consistency', () => {
    it('should maintain brown sack state after closing', () => {
      // Open first
      closeHelper.executeOpen('open sbag');
