/**
 * Scoring Tests - Behind House Scene
...
describe('Scoring - Behind House Scene', () => {
  ...
  describe('First Visit Scoring', () => {
    it('should award points for first visit to behind_house', () => {
      // Reset scoring state
      scoringHelper.resetScoringState();
      testEnv.services.gameState.setCurrentScene('behind_house');
      testEnv.services.gameState.updateSceneRuntimeState('behind_house', { visited: false });
