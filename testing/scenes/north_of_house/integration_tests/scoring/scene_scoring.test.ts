/**
 * Scoring Tests - North of House Scene
...
describe('Scoring - North of House Scene', () => {
  ...
  describe('First Visit Scoring', () => {
    it('should award points for first visit to north_of_house', () => {
      // Reset scoring state
      scoringHelper.resetScoringState();
      testEnv.services.gameState.setCurrentScene('north_of_house');
      testEnv.services.gameState.updateSceneRuntimeState('north_of_house', { visited: false });
      ...
      expect(testEnv.services.gameState.hasVisitedScene('north_of_house')).toBe(true);
