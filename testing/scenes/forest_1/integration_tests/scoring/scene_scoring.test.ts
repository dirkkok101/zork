...
describe('Scoring - Forest Scene', () => {
  ...
  describe('First Visit Scoring', () => {
    it('should award points for first visit to forest_1', () => {
      // Reset scoring state
      scoringHelper.resetScoringState();
      testEnv.services.gameState.setCurrentScene('forest_1');
      testEnv.services.gameState.updateSceneRuntimeState('forest_1', { visited: false });
      ...
      expect(testEnv.services.gameState.hasVisitedScene('forest_1')).toBe(true);
